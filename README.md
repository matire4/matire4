<h1 align="center">¡Hola, soy Matías Re! 👋</h1>
<p align="center">
  Full-Stack Developer (Next.js + Express/TypeScript) · Estudiante de Ing. Informática (UADE) · Buenos Aires, 🇦🇷
</p>

<div align="center">
  <a href="mailto:remati6870@gmail.com">
    <img src="https://img.shields.io/static/v1?message=Email&logo=gmail&label=&color=D14836&logoColor=white&labelColor=&style=for-the-badge" height="32" alt="Email" />
  </a>
  ...
  <a href="https://matire4.vercel.app" target="_blank">
    <img src="https://img.shields.io/static/v1?message=Portfolio&logo=vercel&label=&color=000000&logoColor=white&labelColor=&style=for-the-badge" height="32" alt="Portfolio" />
  </a>
</div>
...
- 🚀 Lidero `Estadías-App`, una plataforma para instituciones educativas con stack Next.js + Express + Neon Postgres.
- 📊 Diseño pipelines de datos híbridos (MongoDB + Cassandra) y dashboards con foco en UX limpia.
- 🛠️ Me entusiasman DevOps, automatizaciones CI/CD y la observabilidad con Grafana/Prometheus.
- 🤝 Abierto a colaborar en productos web, analítica self-service y sistemas que escalen sin fricción.
...
- ♻️ Infra como código con Terraform y despliegues GitOps (ArgoCD).
- 🔐 Observabilidad segura: OpenTelemetry, alerting y políticas RBAC.
- 🎨 Component libraries accesibles con Tailwind + Radix UI.
...
<sub>Siempre abierto a feedback, ideas y nuevas colaboraciones ✉️</sub>
